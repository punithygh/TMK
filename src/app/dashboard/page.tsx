      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 shrink-0">
          <div className="bg-[#0c1220] border border-slate-800 rounded-2xl p-6 sticky top-24 shadow-2xl">
            <div className="flex flex-col items-center mb-8">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-red-500 to-red-600 dark:from-sky-500 dark:to-blue-600 flex items-center justify-center text-3xl font-bold text-white mb-4 shadow-lg shadow-red-600/20 dark:shadow-sky-500/20">
        ...
        <div className="flex-1">
          <div className="mb-6 flex items-center gap-3">
            <LayoutDashboard className="text-red-600 dark:text-sky-500" size={28} />
